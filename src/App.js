...
function App() {
  ...
  return (
    ...
    <Row type='category' title={["WOMEN","MEN","KIDS"]} style={'indented'} items={categoryCards} />
    <Row type='product' title="New Arrivals" style={'indented'} items={productsList.concat(productsList)} />
